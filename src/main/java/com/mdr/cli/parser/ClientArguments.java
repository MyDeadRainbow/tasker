...
public enum ClientArguments implements Argument {
    ...
    private static final Logger log = Logger.getLogger(ClientArguments.class.getName());
    ...
    public void onError(String errorMessage, Throwable throwable) {
        log.log(Level.SEVERE, this.name() + ": " + errorMessage, throwable);
        // onError.accept(errorMessage, throwable);
    }
    ...
    private static void sendCommand(String command) {
        try (Socket clientSocket = new Socket("localhost", Props.APP_PORT.get())) {
            ...
            log.log(Level.SEVERE, "Error occurred while sending command: " + command, e);
        }
    }
}